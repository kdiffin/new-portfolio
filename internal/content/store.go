...
func NewStore(queries *db.Queries) *Store {
	...
	seed := map[string][]*models.Entry{
		...
		"micro": {
			...
			newEntry("micro", "m-006", "Shipping fast and thinking slow", "Everything being measured via velocity and output has ruined our learning (kinda).", time.Date(2026, time.April, 26, 0, 0, 0, 0, time.UTC), []string{"micro"}),
		},
		"books": {},
	}
